    ...
    <div className={`bg-white dark:bg-gray-800  text-black dark:border-gray-800 p-4 ${darkMode ? 'dark-mode' : 'light-mode'} rounded-xl border max-w-xl`}>
      <div className="flex justify-between">
        <div className="flex items-center">
          <img className="h-11 w-11 rounded-full" src={profileImageUrl} alt="Profile"/>
      ...
      <p className=" dark:text-white max-w-48 min-w-48  sm:min-w-[505px] block text-sm leading-snug mt-3">{cleanString}</p>
