...
const BlogCard = ({ d }) => {
  ...
  return (
    ...
    <div  className={`bg-white ${darkMode ? 'dark-mode' : 'light-mode'} dark:hover:bg-red-600 ${darkMode ? ' hover:bg-black' : 'light-mode'} hover:bg-gray-100  transition-all duration-100 dark:bg-gray-800 border-gray-200 dark:border-gray-800 dark:text-gray-100 p-4 rounded-xl border max-w-xl`}>
